...
public static class SummaryExtensions
{
    ...
    //{
    //    return GetSummary(propertyInfo.DeclaringType!, $"P:{propertyInfo.DeclaringType!.FullName}.{propertyInfo.Name}");
    //}
    ...
    //{
    //    return GetSummary(methodInfo.DeclaringType!, $"M:{methodInfo.DeclaringType!.FullName}.{methodInfo.Name}");
    //}
