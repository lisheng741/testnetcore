...
using BackgroundTaskQueueTest.EventBus.Default;
using BackgroundTaskQueueTest.EventBus.Local;
using BackgroundTaskQueueTest.EventBus.RabbitMq;
using BackgroundTaskQueueTest.EventBus.Redis;
...
{
    public static EventBusBuilder AddEventBusCore(this IServiceCollection services)
    {
        // 构建 EventBusBuilder
